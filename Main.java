...
//variable section
    ...
    public void start(Stage primaryStage){
        try{
            ...
            primaryStage.setTitle("Snake Geyim");
            ...
            AtomicReference<String> key2check = new AtomicReference<>("");
            ...
            System.out.println("I have shitted master");
...
public static void tick(GraphicsContext gc) {
        ...
        for (int i = 1;i<snake.size();i++) {
            if (snake.get(0).x == snake.get(i).x && snake.get(0).y == snake.get(i).y/* && (direction.toString().equals(aa))*/) {// to make game easier
                gameOver = true;
                break;
            }
        }
